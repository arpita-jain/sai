<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1>Administrators <small>manage all admins</small></h1>
                <ol class="breadcrumb">
                    <li><a href="<?php echo site_url(); ?>"><i class="icon-dashboard"></i> Dashboard</a></li>
                    <li class="active"><i class="icon-group"></i> Administrators</li>
                </ol>
            </div>
        </div><!-- /.row -->
        <div class="row">
            <div class="col-lg-12">
				...
				<th>Status</th>
					...
					?>
                                            <a href="javascript:void(0);" onclick="set_adminstatus('<?php echo $row['id']; ?>');"><i id="status_<?php echo $row['id']; ?>" class='<?php echo $class; ?> text-success icon-large'></i></a>
                                        <?php } else { $class="icon-minus-sign"; ?>
                                            <a href="javascript:void(0);" onclick="set_adminstatus('<?php echo $row['id']; ?>');"><i id="status_<?php echo $row['id']; ?>" class='<?php echo $class; ?> text-error icon-large'></i></a>
                                        <?php } ?>
                                    </td>
                                    <td>
...
<script src="<?php echo base_url(); ?>assets/scripts/admins.js"></script>
<script src="<?php echo base_url(); ?>assets/scripts/common.js"></script>
<script>
$(document).ready(function() {
    $("#admins_menu").addClass("active");
});
</script>
<?php
/*
  ...
  File Location: ./application/views/admin/admins.php
  Created At : 15 Nov, 2013  1:43:22 PM
 */
?>
