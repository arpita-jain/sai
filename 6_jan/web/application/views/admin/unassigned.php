<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1>Unassigned Kiosks <small>manager</small></h1>
                <div class="btn-group pull-right">
                    <button type="button" class="btn  btn-primary dropdown-toggle " data-toggle="dropdown">
                        <i class="icon-group"></i> Unassigned Kiosks <span class="caret"></span>
                    </button>
...
<script src="<?php echo base_url(); ?>assets/scripts/unassignedkiosks.js"></script>
<script>
                                            $(document).ready(function() {
                                                $("#kioskgroup_menu").addClass("active");
                                            });
</script>
<?php
/*
