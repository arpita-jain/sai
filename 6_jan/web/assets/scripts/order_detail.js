var EventsTable = function() {
    return {
        ...
        init: function() {
            ...
            jQuery('#order_detail .group-checkable').change(function() {
            ...
            jQuery('#order_detail_wrapper .dataTables_filter input').addClass("input-sm"); // modify table search input
            jQuery('#order_detail_wrapper .dataTables_length select').addClass("form-control input-sm"); // modify table per page dropdown
...
function uncheckall()
{
    jQuery("#order_detail .checkboxes").each(function() {
        var tr = $(this).parent().parent();        
        $(this).prop('checked', false);
        $(tr).removeClass("success");    
    });
