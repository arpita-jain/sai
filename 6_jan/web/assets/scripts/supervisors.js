...
function viewAdmin(id) {
    $.ajax({
        ...
        dataType: 'json',
        async: false,
        url: site_path + 'admin_ajax/viewSupervisor',
        data: {
            'id': id
        },
...
function deleteAdmins()
{
    ...
    $.ajax({
        ...
        dataType: 'json',
        async: false,
        url: site_path + 'admin_ajax/delSupervisors',
        data: {
            'ids': ids
        },
        success: function(data) {
    ...
    if (validateUpdatedInputs())
    {
        ...
        if(password==confirm_password) {
            $.ajax({
                ...
                dataType: 'json',
                acync: false,
                url: site_path + 'admin_ajax/editSupervisor',
                data: {
                    'firstname': firstname,
                    'lastname': lastname,
                    'mobile': mobile,
    ...
    if (validateInputs())
    {
        ...
        if(password == confirm_password){
            $.ajax({
                ...
                dataType: 'json',
                acync: false,
                url: site_path + 'admin_ajax/addSupervisor',
                data: {
                    'firstname': firstname,
                    'lastname': lastname,
                    'mobile': mobile,
...
function set_supervisorsstatus(id){
