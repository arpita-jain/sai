var OrderTable = function() {
    return {
        ...
        init: function() {
            ...
            jQuery('#order_table .group-checkable').change(function() {
            ...
            jQuery('#order_table_wrapper .dataTables_filter input').addClass("input-sm"); // modify table search input
            jQuery('#order_table_wrapper .dataTables_length select').addClass("form-control input-sm"); // modify table per page dropdown
