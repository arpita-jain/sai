var EventsTable = function() {
    return {
        ...
        init: function() {
            ...
            jQuery('#events_table .group-checkable').change(function() {
            ...
            jQuery('#events_table_wrapper .dataTables_filter input').addClass("input-sm"); // modify table search input
            jQuery('#events_table_wrapper .dataTables_length select').addClass("form-control input-sm"); // modify table per page dropdown
...
function uncheckall()
{
    jQuery("#events_table .checkboxes").each(function() {
        var tr = $(this).parent().parent();        
        $(this).prop('checked', false);
        $(tr).removeClass("success");    
    });
