...
function viewAdmin(id) {  
    $.ajax({
        ...
        dataType: 'json',
        async: false,
        url: site_path + 'admin_ajax/viewAdmin',
        data:{
            'id': id
        },
...
function deleteAdmins()
{
    ...
    $.ajax({
        ...
        dataType: 'json',
        async: false,
        url: site_path + 'admin_ajax/delAdmins',
        data: {
            'ids': ids
        },
        success: function(data) {
    ...
    if (validateUpdatedInputs())
    {
        ...
        if(password==confirm_password) {
            $.ajax({
                ...
                dataType: 'json',
                acync: false,
                url: site_path + 'admin_ajax/editAdmin',
                data: {
                    'firstname': firstname,
                    'lastname': lastname,
                    'mobile': mobile,
    ...
    if (validateInputs())
    {
        ...
        if(password == confirm_password){
            $.ajax({
                ...
                dataType: 'json',
                acync: false,
                url: site_path + 'admin_ajax/addAdmin',
                data: {
                    'firstname': firstname,
                    'lastname': lastname,
                    'mobile': mobile,
