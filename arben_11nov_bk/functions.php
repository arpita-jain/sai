...
function Show_sidebar_right_joinnow(){ ?>
		   ...
		   <div class="trader-box">
                  <div class="traders-img_txt">
                <div class="traders-img_small"><a href="<?php echo site_url();?>?page_id=710&id=<?php echo $id;?>" style="color:#000;"><img border="0" align="left" src="<?php echo $a1[1];?>" /></div>
                <div class="traders-head-txt" style="color:#000;"><a href="<?php echo site_url();?>?page_id=710&id=<?php echo $id;?>" style="color:#000;"><?php echo $all_meta_for_user['first_name'][0];?><span><?php echo $company;?></span></div>
              </div>
                </div>
		<?php }?>
		<div class="more-traders"><span><a href="<?php echo site_url();?>?page_id=13">More Traders</a></span></div>
		 ...
		 /*for builder listing,trader listing and job listing pages right sidebar*/
			...
			<?php global $wpdb;
			$retrieve_data = $wpdb->get_results("SELECT * FROM wp_jobpost ORDER BY post_date desc limit 0,5");
			foreach ($retrieve_data as $retrieved_data){
			$job_detail=$retrieved_data->job_detail;
			$cont=substr($job_detail, 0, 50);?>
		   <div class="trader-box">
                  <div class="traders-img_txt">
                <div class="traders-img_small"><a href="<?php echo site_url();?>?page_id=509&job=<?php echo $retrieved_data->id; ?>"><img border="0" align="left" src="<?php echo site_url().'/wp-content/plugins/job-post/job_image/'.$retrieved_data->file_name;?>" style="width:40px;height:43px"/></a></div>
		...
		<div class="more-traders"><span><a href="<?php echo site_url();?>?page_id=13">More Traders</a></span> </div>
		 ...
		 /*for builder job listing*/
			...
			<?php global $wpdb;
			$retrieve_data = $wpdb->get_results("SELECT * FROM wp_jobpost ORDER BY post_date desc limit 0,3");
			foreach ($retrieve_data as $retrieved_data){
			$job_detail=$retrieved_data->job_detail;
			$cont=substr($job_detail, 0, 50);?>
		   <div class="trader-box">
                  <div class="traders-img_txt">
                <div class="traders-img_small"><a href="<?php echo site_url();?>?page_id=509&job=<?php echo $retrieved_data->id;?>" style="color:#000;"><img border="0" align="left" src="<?php echo site_url().'/wp-content/plugins/job-post/job_image/'.$retrieved_data->file_name;?>" style="width:40px;height:43px;"/></div>
                <div class="traders-head-txt" style="color:#000;"><a href="<?php echo site_url();?>?page_id=509&job=<?php echo $retrieved_data->id;?>" style="color:#000;"><?php echo $retrieved_data->job_type;?><span><?php echo $cont;?></span></div>
              </div>
                </div>
		<?php } ?>
		...
		$retrieved_data->job_type;
	       ...
	       $Pd = $retrieved_data->post_date;
                    ...
                    <div class="traders-head-txt" style="color:#000;"><span><a href="pdf.php?Jt=<?php echo $Jt;?>&Fn=<?php echo $Fn ;?>&Jl=<?php echo $Jl;?>&Jd=<?php echo $Jd;?>&Cn=<?php echo $Cn;?>&Jty=<?php echo $Jty;?>&Pd=<?php echo $Pd;?>" id="download_link" style="color: #707070;">Download this PDF</a></span></div>
                  </div>
                </div>
		<div class="trader-box">
                      <div class="traders-img_txt">
                    <div class="traders-head-txt" style="color:#000;"><span>Images of the JOB</span></div>
                  </div>
                    </div>
		 <?php }
...
<tbody><tr>
<td>Your Name </td>
<td>      <span><input type="text" aria-required="true" size="40" value="" name="your-name"></span> </td>
</tr>
<tr>
<td>email Address </td>
<td>  <span><input type="email" aria-required="true" size="40" value="" name="your-email"></span> </td>
</tr>
<tr>
<td>Subject  </td>
<td>   <span"><input type="text" size="40" value="" name="your-subject"></span> </td>
</tr>
<tr>
<td>Message   </td>
<td>   <span><textarea rows="10" cols="40" name="your-message"></textarea></span> </td>
</tr>
<tr>
<td><input type="submit" value="Enquiry"></td>
</tr>
</tbody></table>
</div>
<?php }
