...
<div class="container back_bg">
    ...
    <div class="twelvecol">
        ...
        <?php /*    <p><a href="#">Advanced search</a></p>*/ ?>
          </div>
            </div>
        <div class="search_button"> <span>
          <input type="button" name="txtEmail" value="Search">
          </span> </div>
        <div class="join_now"> <span>
          <input type="button" name="txtEmail" value="Join Now">
          </span>
      ...
      <div class="category_box_main">
        <?php if ( ! dynamic_sidebar( 'Social Widget Area ' ) ) :  endif; ?>
      </div>
      </div>
  </div>
    </div>
<div class="container content_bg">
    ...
    <div class="twelvecol">
        ...
        <div class="traders_part">
            ...
            <div class="title_cate">Recent Traderssssssss</div>
	    
            <div class="img_txt">
                  <div class="img_small"><img border="0" align="left" src="<?php bloginfo('template_url')?>/images/img_cate.png" /></div>
                  <div class="txt_cate"><?php echo $all_meta_for_user['first_name'][0];?><span>Lorem ipsum dolor sit amet ad ipisicing consectetur</span></div>
                </div>
            ...
            <div class="img_txt_2">
                  <div class="img_small"><img border="0" align="left" src="<?php bloginfo('template_url')?>/images/img_cate.png" /></div>
                  <div class="txt_cate">abcd<span>Lorem ipsum dolor sit amet ad ipisicing consectetur</span></div>
