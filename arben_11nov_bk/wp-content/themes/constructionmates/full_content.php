    ...
    <div class="twelvecol">
      <div class="term-condition-area">
		   ...
		   <?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
		    ...
		    <div class="term-condition-bg" style="position: relative;">
				<?php
			if(!is_page('1465'))
			{ ?><h3><?php the_title();?>
		    </h3>
		 ...
		 <div style="margin:0px 10px;"><span><a href="<?php echo site_url();?>?page_id=1465" class="active_arrow">Home</a></span></div>
		   <div style="margin:0px 10px;">
			 <span>
              ...
              <div style="margin:0px 10px;"><span> <a href="<?php if($user_type==1 || $user_type==4){echo site_url().'?page_id=487&usertype='.$user_type; }elseif($user_type==2 || $user_type==3){echo site_url().'?page_id=442&usertype='.$user_type; }?>">My Account</a></span>
	      </div>
               </div>
			  <?php
		   $kcount=0;
