...
function home_tab_slider(){
	$kcount=0;
				  ...
				  <input type="hidden" value="" id="kpost_count"/> <div>
				      <div id="pre" style="float: left; width: 30px; height:30px; margin-top:38%; cursor: pointer; color: #fff; background-image: url('http://constructionmates.co.uk/wp-content/themes/constructionmates/images/prv.png')"; next_val="" onclick="">Prev</div>
					  ...
					  $i=1;
					  ?>
					  <div class="hh" style="background: #2c96d4; display: block; height: 50px;">
					  <?php
					  while ($popular->have_posts()) : $popular->the_post();
					  {
					      ?>
					      <div class="testcls<?php //echo $i;?>" id="id_click<?php echo $i;?>" style="display: block; width: 180px; color: #fff; border-right:1px solid #fff; line-height: 50px; height: 50px; text-align: center; float: left; cursor: pointer;" onclick="display(<?php echo $i;?>)">
						  <?php the_title(); ?>
					      </div>
					      <?php
					      $i=$i+1;
				      ...
				      <div id="next" style="float: left; width: 30px; height:30px; margin-top:38%; cursor: pointer; color: #fff; background-image: url('http://constructionmates.co.uk/wp-content/themes/constructionmates/images/next.png')" pre_val="" onclick="">Next</div>
				  </div>	
							    <?php
							    //echo 'slider';
}
