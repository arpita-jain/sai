...
<div class="container content_bg-new">
	...
	<?php   $user_id= $current_user->ID; 
	     ...
	     <div><span><a href="<?php echo site_url();?>?page_id=1465">Home</a></span></div>
              <div><span><a href="<?php if($user_type ==2){ echo site_url().'?page_id=15'; }else {  echo site_url().'?page_id=1044'; }?>">Jobs</a></span></div>
	      ...
	      <div><span><a href="<?php echo site_url();?>?page_id=437&page=rwpm_frontend_inbox" class="active_arrow">Messages</a></span></div>
...
<div class="hfeed content">
	...
	<div class="post" id="post-<?php the_ID(); ?>">
		...
		<div id="pm-inbox" <?php if (!$show[1]) echo 'style="display:none"'; ?>><?php rwpm_frontend_inbox();?></div>
		<div id="pm-outbox" <?php if (!$show[2]) echo 'style="display:none"'; ?>><?php rwpm_front_message_outbox();?></div>
	</div>
	<?php endwhile; endif; ?>
</div>
</div>
