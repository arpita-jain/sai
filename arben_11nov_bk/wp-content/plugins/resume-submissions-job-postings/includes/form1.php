...
<div id="resumeSubmission">
	...
	if ( $formError == true || $action != 'add' ) {
		...
		<form id='formSubmission' method='POST' action="" enctype="multipart/form-data" name="123">
		<table width="100%" cellpadding="0" cellspacing="5">
			...
			if ( grabContents( get_option( 'resume_input_fields' ), 'fname', 0 ) ) {	
				?>
				<tr>
					<td class="temp_bg"><p><?php _e( 'First Name' ); ?>: </p></td>
					<td valign="top" align="left"><input type='text' name='fname' size='25' value='<?php if (  $UId[0]->fname == '' ) echo $current_user->user_firstname; else echo $UId[0]->fname; ?>' />
			...
			if ( grabContents( get_option( 'resume_input_fields' ), 'lname', 0 ) ) {	
				?>
				<tr>
					<td class="temp_bg"><p><?php _e( 'Last Name' ); ?>: </p></td>
					<td valign="top" align="left"><input type='text' name='lname' size='25' value='<?php if (  $UId[0]->lname == '' ) echo $current_user->user_lastname; else echo $UId[0]->lname; ?>' />
			...
			if ( grabContents( get_option( 'resume_input_fields' ), 'address', 0 ) ) {	
				?>
				<tr>
					<td class="temp_bg"><p><?php _e( 'Address' ); ?>: </p></td>
					<td valign="top" align="left"><input type='text' name='address' size='25' value='<?php echo $UId[0]->address ; ?>' />
			...
			if ( grabContents( get_option( 'resume_input_fields' ), 'address2', 0 ) ) {	
				?>
				<tr>
					<td class="temp_bg"><p><?php _e( 'Address2' ); ?>: </p></td>
					<td valign="top" align="left"><input type='text' name='address2' size='25' value='<?php echo $UId[0]->address2; ?>' />
			...
			if ( grabContents( get_option( 'resume_input_fields' ), 'city', 0 ) ) {	
				...
				<tr>
					...
					<td valign="top" align="left"><input type='text' name='city' size='25' value='<?php echo $UId[0]->city; ?>' />
			...
			if ( grabContents( get_option( 'resume_input_fields' ), 'state', 0 ) ) {
				...
				?>
				<tr>
					<td class="temp_bg"><p><?php _e( 'State' ); ?>: </p></td>
			...
			if ( grabContents( get_option( 'resume_input_fields' ), 'zip', 0 ) ) {	
				?>
				<tr>
					<td class="temp_bg"><p><?php _e( 'postcode' ); ?>: </p></td>
					<td valign="top" align="left"><input type='text' name='zip' size='25' value='<?php echo $UId[0]->zip; ?>' /> <sup><?php echo displayRequired( grabContents( get_option( 'resume_input_fields' ), 'zip', 1 ) ); ?></sup></td>
				</tr>
				<?php
			}
			if ( grabContents( get_option( 'resume_input_fields' ), 'pnumber', 0 ) ) {	
				?>
				<tr>
					<td valign="top" class="temp_bg" ><p><?php _e( 'Primary Contact Number' ); ?>: </p></td>
			...
			if ( grabContents( get_option( 'resume_input_fields' ), 'snumber', 0 ) ) {	
				?>
				<tr>
					<td valign="top" class="temp_bg"><p><?php _e( 'Secondary Contact Number' ); ?>: </p></td>
			...
			if ( grabContents( get_option( 'resume_input_fields' ), 'email', 0 ) ) {	
				?>
				<tr>
					<td class="temp_bg"><p><?php _e( 'E-Mail Address' ); ?>: </p></td>
					<td valign="top" align="left"><input type='text' name='email' size='25' value='<?php if ( $UId[0]->email == '' ) echo $current_user->user_email; else echo $UId[0]->email; ?>' />
		...
		<table width="100%" cellpadding="0" cellspacing="0" id="resume">
			...
			<tr>
				<td class="plan_btn"><p ><input type='submit' value='<?php _e( 'Create Resume' );?>' name='submit' /></p></td>
			</tr>
		</table>
		</form>
        <?php
