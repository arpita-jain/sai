...
if(is_admin()){
	...
	wp_register_script( 'xyz_calender_script', plugins_url('newsletter-manager/js/epoch_classes.js') );
	wp_enqueue_script( 'xyz_calender_script' );
...
// 	wp_enqueue_style( 'xyz_em_style');
	function xyz_em_add_style(){
		// Register stylesheets
		wp_register_style('xyz_em_style', plugins_url('newsletter-manager/css/xyz_em_styles.css'));
		wp_enqueue_style('xyz_em_style');
	}
	add_action('init', 'xyz_em_add_style');
