function getExistdata()
{
        ...
        if(x != null || x !="")
        {
                for(var j=1;j<=x;j++)
                {
                        document.getElementById('img_'+j).src="wp-content/plugins/ratings/images/ratingstar2.png";	
                }
        }
}
...
function rating_fun(myval)
{
        ...
        for(var i=1;i<=5;i++)
        {
                document.getElementById('img_'+i).src="wp-content/plugins/ratings/images/ratingstar.png";
        }
        for(var i=1;i<=myval;i++)
        {
                document.getElementById('img_'+i).src="wp-content/plugins/ratings/images/ratingstar2.png";
        }
