	...
	<?php }elseif($counter==2){?>	
	  ...
	  <?php }}?>
        ...
        <div class="latest_part">
	      ...
	      <br/>
	      <?php $retrieve_data = $wpdb->get_results("SELECT jp.id as job_id,jp.job_category,jc.id,jc.category,COUNT(*) as noj FROM wp_jobpost as jp INNER JOIN wp_jobcategory as jc ON jp.job_category=jc.id GROUP BY jp.job_category ORDER BY jp.post_date DESC");
	      $j=0;
	      foreach ($retrieve_data as $retrieved_data){
		$j=$j+1;
		if($j%2==1)
		{
		?>
	      <div class="left_job"><a href="<?php echo site_url();?>?page_id=1188&job_id=<?php echo $retrieved_data->job_id; ?>"><?php echo $retrieved_data->category;?><span>(<?php echo $j_id=$retrieved_data->noj;?>)</span></a> </div><?php }
	      else
	      {?>
	       <div class="left_job last"><a href="<?php echo site_url();?>?page_id=1188&job_id=<?php echo $retrieved_data->job_id; ?>"><?php echo $retrieved_data->category;?><span>(<?php echo $j_id=$retrieved_data->noj;?>)</span></a> </div>
	      <?php
		}
		}?>
