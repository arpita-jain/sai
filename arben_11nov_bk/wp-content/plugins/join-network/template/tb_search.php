...
if($searchbox || $city)
	  ...
	  if($items > 0) {
        ...
        $p->target(site_url()."?page_id=1359");
	  ...
	  <form action="<?php echo site_url().'?page_id=1359'?>" method="post" name="searchform" id="searchform">
		  ...
		  <div class="job_search_field_main">
			   <div class="job_search-field"> <span>Search Results</span><br>
				 ...
				 <div class="view-job-btn"><span><a href="<?php echo get_page_link(1359); ?>">View All</a></span></div>
				 </span>
			      </div>
			   </div>
		    </div>    
		  ...
		  $all_meta_for_user = get_user_meta($id);?>
		    ...
		    $a1=explode("'",$a[1]);?>
			 ...
			 ?>
			      ...
			      <div class="acrdtn-smal-btn"><span><p><?php if(isset($accred)){ echo $ac1[1];}else{echo "First AID";}?></p></span> </div>
			      <div class="acrdtn-smal-btn"><span><p><?php if(isset($accred)){ echo $ac1[2];}else{echo "Gas Safe";}?></p></span> </div>
			      <div class="acrdtn-smal-btn"><span><p><?php if(isset($accred)){echo $ac1[3];}else{echo "City Guids";}?></p></span> </div>
			      <div class="acrdtn-smal-btn"><span><p><?php if(isset($accred)){echo $ac1[4];}else{echo "IPAF";}?></p></span> </div>
			      <div class="acrdtn-smal-btn"><span><p><?php if(isset($accred)){echo $ac1[5];}else{echo "PASHA";}?></p></span> </div>
			      </div>
			 <?php
			 // echo $all_meta_for_user['usertype'][0];
			 if($all_meta_for_user['usertype'][0]=='2'){  $pageid=710; }elseif($all_meta_for_user['usertype'][0]=='3'){$pageid=702;}?>
			 <div class="read-more-job-btn"><span><a href="<?php echo site_url().'?page_id='.$pageid.'&id='.$id;?>">Read More</a></span> </div>
			 </div>
		    </div>
	  <?php }
