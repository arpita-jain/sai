...
if($searchbox || $city)
	  ...
	  if($items > 0) {
        ...
        $p->target(site_url()."?page_id=13&theme=handheld");
...
<form action="<?php echo site_url().'?page_id=13&theme=handheld'?>" method="post" name="searchform" id="searchform">
    <div class="build_search_field_main">
 ...
 <h1 class="traders"> Traders</h1>
   
<ul class="tab_2list">
       <?php foreach ($retrieve_data as $retrieved_data){
		  $id= $retrieved_data->user_id;
		  $all_meta_for_user = get_user_meta($id);?>
<li><div class="more_btn"><a href="<?php echo site_url();?>?page_id=710&id=<?php echo $id;?>&theme=handheld"><img src="<?php echo site_url();?>/wp-content/themes/constructionmatesss_mob/images/more.png" alt="more"></a></div>
