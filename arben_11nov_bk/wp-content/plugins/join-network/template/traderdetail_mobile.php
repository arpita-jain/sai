 ...
 <script type="text/javascript">
  ...
  <div class="tabs_search">
	...
	<span><a href="#"><?php echo $all_meta_for_user['city'][0]; ?></a> |<a id="distance" href="#"></a></span>
		...
		<p class="detail_btn_box"><a href="#"><?php echo $all_meta_for_user['available'][0]; ?></a><a href="#" id="request_link">Request My CV</a><?php if($user=="")
		 {?><a href="<?php echo site_url().'?page_id=330&theme=handheld'?>" >Quote Me</a><?php } else {?><a href="<?php echo site_url().'?page_id=1423&id= '.$id.'&theme=handheld'?>" >Quote Me</a><?php } ?>
		 <?php if($user_id!=$trader_id){ echo do_shortcode('[cis_rating]'); }?></p>
      </div>
