...
<div class="content-left-part">
	 ...
	 <div class="job-list-area">
              <h3 class="heading_box">Builders</h3>
...
?>
		<div class="acrdtn-smal-btn-area">
		 ...
		 <div class="read-more-job-btn"><span><a href="<?php echo site_url();?>?page_id=702&id=<?php echo $id;?>">Read More</a></span> </div>
	    </div>
          </div>
