...
#featured_slider a{font-family: 'helvetica_neue_lt_std45_light'; font-size: 22px; line-height: 18px; font-weight:normal; color:#000;}
...
#featured_slider .content_left h2{ margin-bottom:11px!important;}
...
font-family: 'helvetica_neue_lt_std45_light'; font-size:14px;}
...
<div id="featured_slider">
	...
	<ul id="slider">
		...
		<li><div class="content_left"><h2><a href="<?php the_permalink();?>"><?php the_title();?></a></h2><?php echo c_slider_cut_text(get_the_content(), $c_slider_limit, $c_slider_points);?></div><div class="img_right"><a href="<?php the_permalink();?>"><?php echo get_the_post_thumbnail($post_id);?></a></div></li>
