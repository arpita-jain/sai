...
if(count($campCount)==0){
	...
	$wpdb->query( 'DELETE FROM  '.$wpdb->prefix.'xyz_em_attachment  WHERE campaigns_id="'.$xyz_em_campId.'" ' ) ;
	
	$wpdb->query( 'DELETE FROM  '.$wpdb->prefix.'xyz_em_email_campaign  WHERE id="'.$xyz_em_campId.'" ' ) ;
