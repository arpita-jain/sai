...
.button{
 ...
 <?php
	  ...
	  //Update table  
	   ...
	   echo  $myAv->edit_user_profile_update($id);
	   //echo  $sql=("UPDATE wp_usermeta SET simple_local_avtar = replace(simple_local_avtar,$match[0], $p_image) where user_id=$id");
	    }
...
<div class="join-field-part">
            ...
            <div class="join-name-field join-name">
                ...
                <div class="join-firstname-field join-name-spc-rgt">
                  <div class="job-input-bg"> <span>
                    <input name="first_name" value="<?php echo $all_meta_for_user['first_name'][0]; echo $all_meta_for_user['usertype'][0];?>"/>
                    </span> </div>
                </div>
		    ...
		    <option>Your Postcode</option>
                  ...
                  <h4>Maximum 8 for trades and 10 for builders</h4> <!--<input type="submit" name="submit" value="submit">--> 
                </div>
