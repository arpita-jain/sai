...
function login_header($title = 'Log In', $message = '', $wp_error = '') {
	...
	<div id="login">
		<?php do_action('mbt_login_heading'); ?>
	<?php
...
<form name="resetpassform" id="resetpassform" action="<?php echo esc_url( site_url( 'wp-login.php?action=resetpass&key=' . urlencode( $_GET['key'] ) . '&login=' . urlencode( $_GET['login'] ), 'login_post' ) ); ?>" method="post">
	<div class="login_form_container">
		...
		<p>
			<input type="password" name="pass1" id="pass1" class="input" size="20" value="" placeholder="<?php _e('New password') ?>" autocomplete="off" /></label>
		</p>
		<p>
			<input type="password" name="pass2" id="pass2" class="input" size="20" value="" placeholder="<?php _e('Confirm new password') ?>" autocomplete="off" /></label>
		</p>
	</div>
