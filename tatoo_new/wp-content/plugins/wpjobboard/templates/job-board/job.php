...
<link rel="stylesheet" type="text/css" href="<?php echo site_url().'/wp-content/plugins/wpjobboard/js/imgareaselect-default.css';?>" />
<script type="text/javascript" src="<?php echo site_url().'/wp-content/plugins/wpjobboard/js/jquery.min.js'?>"></script>
<script type="text/javascript" src="<?php echo site_url().'/wp-content/plugins/wpjobboard/js/jquery.imgareaselect.js'?>"></script>
    <table class="wpjb-info">
        <tbody>
            ...
            <tr>
                <td class="wpjb-info-label"><?php _e("Primary Style", WPJB_DOMAIN) ?></td>
