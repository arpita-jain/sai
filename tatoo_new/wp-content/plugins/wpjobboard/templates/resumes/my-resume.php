...
//include_once(ABSPATH.'wp-content/plugins/wpjobboard/js/jquery-pack.js');
//include_once(ABSPATH.'wp-content/plugins/wpjobboard/js/jquery-pack.js/jquery.imgareaselect.min.js');
?>
<div id="wpjb-main" class="wpjr-page-my-resume">

    <?php wpjb_flash() ?>

    <form action="" method="post" id="wpjb-resume" class="wpjb-form" enctype="multipart/form-data" name="photo">
   
   
        <?php if( mbt_get_user_type() == 'artist' ) {
            // if(isset($_POST['Submit']))
            
    //{
        //echo $resume->getImageUrl();
        //echo "hiii";
        ?><!--<img src="<?php echo $resume->getImageUrl();?>" alt="" id="thumbnail">-->
    <?php //}
            ?>
