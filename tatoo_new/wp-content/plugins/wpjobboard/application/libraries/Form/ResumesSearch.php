...
class Wpjb_Form_ResumesSearch extends Daq_Form_Abstract
{
    public function init()
    {
        ...
        $e->setValue(__("title, experience ...", WPJB_DOMAIN));
        ...
        $e = new Daq_Form_Element("category", Daq_Form_Element::TYPE_CHECKBOX);
        $e->setLabel(__("Primary Style", WPJB_DOMAIN));
        $e->addOption(null, null, "All");
        foreach(Wpjb_Utility_Registry::getCategories() as $obj) {
            $e->addOption($obj->id, $obj->id, $obj->title);
        }
        //$category_values = maybe_unserialize($this->_object->category_id);
        //$e->setValue($category_values);
        ...
        $e->addOption(31, null, __("All", WPJB_DOMAIN));
        $this->addElement($e, "search");
