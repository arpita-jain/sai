...
class Wpjb_Project extends Daq_ProjectAbstract
{
    ...
    public function run()
    {
        ...
        add_action('user_register', array(self::$_instance, "createEmployer"));
        add_action('delete_user', array(self::$_instance, "removeEmployer"));
    ...
    public function createEmployer($id)
    {
