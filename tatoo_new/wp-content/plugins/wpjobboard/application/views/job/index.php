...
<table cellspacing="0" class="widefat post fixed">
    ...
    <<?php echo $tx; ?>>
        <tr>
            ...
            <th style="" class="" scope="col"><?php _e("Primary Style", WPJB_DOMAIN) ?></th>
	...
	<tr valign="top" class="<?php if($i%2==0): ?>alternate <?php endif; ?> author-self status-publish iedit">
            ...
            $cats = array();
            foreach ((array)$item->getCategory(true) as $category) {
                if ($category->title) $cats[] = $category->title;
            }
            echo esc_html(join(', ', $cats));
            ?></td>
