...
get_header( 'buddypress' ); ?>
	...
	<div class="page-title"><?php the_title(); ?></div>
		...
		<div class="padder">
			...
			<?php echo of_get_option('t-13', 'You can browse all activities here. Use menu below if you want to browse only specific activities like Group Memberships, New Topics, New Members ...' ); ?><br />
