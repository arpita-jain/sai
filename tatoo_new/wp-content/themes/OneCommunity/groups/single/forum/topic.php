...
<form action="<?php bp_forum_topic_action(); ?>" method="post" id="forum-topic-form" class="standard-form">
	...
	<?php if ( bp_has_forum_topic_posts() ) : ?>
		...
		<table id="topic-post-list" class="item-list" role="main">
			...
			<td class="post-author-cell"><div class="post-author"><a href="<?php bp_the_topic_post_poster_link(); ?>"><?php bp_the_topic_post_poster_avatar( 'width=50&height=50' ); ?></a></div></td>
			
			<td class="topic-content-cell">
			<div class="topic-content">
			<p class="topic-meta"><?php echo sprintf( __( '%1$s said %2$s:', 'buddypress' ), bp_get_the_topic_post_poster_name(), bp_get_the_topic_post_time_since() ); ?></p>
