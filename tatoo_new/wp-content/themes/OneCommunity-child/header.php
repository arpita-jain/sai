	...
	<div class="mbt_bar">
		<div id="container">
			...
			<section class="user_btns fleft">
				...
				if ( $user_type == 'studio' ) : ?>
				       <!-- <a href="<?php //echo home_url('/job-resume/'); ?>">Job Description</a>-->
					<a href="/tatoo/jobs/add">Post a job</a>
				<?php elseif ( $user_type == 'artist' ) : ?>
				       <!--<a href="<?php //echo home_url('/job-resume/'); ?>">Resume Description</a>-->
					<a href="/tatoo/resumes/my-resume">My Resume</a>
				<?php endif; ?>
			</section>
