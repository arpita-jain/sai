		...
		<?php while ( bp_thread_messages() ) : bp_thread_the_message(); ?>
			...
			<div class="message-box <?php bp_the_thread_message_alt_class(); ?>">
				...
				<div class="message-metadata">
					...
					if ( mbt_is_user_online( $thread_template->message->sender_id ) ) { $state = 'online'; } 
					?>
					<strong><a href="<?php bp_the_thread_message_sender_link(); ?>" title="<?php bp_the_thread_message_sender_name(); ?>"><?php bp_the_thread_message_sender_name(); ?></a> <span class="activity <?php echo $state; ?>"><?php bp_the_thread_message_time_since(); ?></span></strong>
